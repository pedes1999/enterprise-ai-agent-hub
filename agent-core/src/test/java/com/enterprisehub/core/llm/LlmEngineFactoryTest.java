...
class LlmEngineFactoryTest {
    ...
    void create_anthropic_returnsAnthropicChatModel() {
        ...
        ChatModel model = factory.create(LlmProvider.ANTHROPIC, "fake-test-key", "claude-3-5-sonnet-20240620");
    ...
    void create_openAi_returnsOpenAiChatModel() {
        ChatModel model = factory.create(LlmProvider.OPENAI, "fake-test-key", "gpt-4o-mini");
    ...
    void create_gemini_returnsGoogleAiGeminiChatModel() {
        ChatModel model = factory.create(LlmProvider.GEMINI, "fake-test-key", "gemini-1.5-flash");
    ...
    void create_local_returnsOpenAiChatModel_reusingTheOpenAiCompatibleWireFormat() {
        ...
        ChatModel model = factory.create(LlmProvider.LOCAL, "fake-key", "llama3.1", "http://localhost:11434/v1");
    ...
    void create_local_noBaseUrlSupplied_stillBuildsWithoutThrowing() {
        ...
        ChatModel model = factory.create(LlmProvider.LOCAL, "fake-key", "llama3.1");
    ...
    void create_local_blankApiKey_stillBuildsWithoutThrowing() {
        ...
        ChatModel model = factory.create(LlmProvider.LOCAL, "", "llama3.1", "http://localhost:11434/v1");
